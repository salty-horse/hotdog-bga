 ...
 * particular, you can set here the values of variables elements defined in hotdog_hotdog.tpl (elements
...
class view_hotdog_hotdog extends game_view {
    ...
    function build_page($viewArgs) {
        ...
        $this->tpl['BIDDING_PHASE'] = self::_('Bidding phase');
